...
risk_tuple='(100000000,300000000,500000000,1000000,6000,7500,8000,500,1000,1000,10000,20000,1200,600,3600,4,6,0)'
oracle_tuple="($MIN_AGE,$UPDATE_INTERVAL,$STALE_AFTER,20000000,16,4)"
